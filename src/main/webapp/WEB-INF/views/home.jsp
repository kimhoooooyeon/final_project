...
<div class="category-list" ng-hide='$location.path() != "/"'>
	...
	<!-- 이부분 까지햇음 -->
		...
		<div class="col-xs-6 col-sm-4 col-md-4"><a href="/shoplist?category_num=3" class="thumbnail" ng-click="select_home_category('치킨')" ><div class="category-title">치킨</div><img src="/resources/images/category-02.png"></a></div>
		<div class="col-xs-6 col-sm-4 col-md-4"><a href="/shoplist?category_num=4" class="thumbnail" ng-click="select_home_category('피자양식')"><div class="category-title" >피자/양식</div><img src="/resources/images/category-03.png"></a></div>
		<div class="col-xs-6 col-sm-4 col-md-4"><a href="/shoplist?category_num=5" class="thumbnail" ng-click="select_home_category('중식')"><div class="category-title" >중국집</div><img src="/resources/images/category-04.png"></a></div>
		<div class="col-xs-6 col-sm-4 col-md-4"><a href="/shoplist?category_num=6" class="thumbnail" ng-click="select_home_category('한식')"><div class="category-title" >한식</div><img src="/resources/images/category-05.png"></a></div>
		<div class="col-xs-6 col-sm-4 col-md-4"><a href="/shoplist?category_num=7" class="thumbnail" ng-click="select_home_category('일식돈까스')"><div class="category-title" >일식/돈까스</div><img src="/resources/images/category-06.png"></a></div>
		<div class="col-xs-6 col-sm-4 col-md-4"><a href="/shoplist?category_num=8" class="thumbnail" ng-click="select_home_category('족발보쌈')"><div class="category-title" >족발/보쌈</div><img src="/resources/images/category-07.png"></a></div>
		<div class="col-xs-6 col-sm-4 col-md-4"><a href="/shoplist?category_num=10" class="thumbnail" ng-click="select_home_category('분식')"><div class="category-title" >분식</div><img src="/resources/images/category-09.png"></a></div>
		<div class="col-xs-6 col-sm-4 col-md-4"><a href="/shoplist?category_num=11" class="thumbnail" ng-click="select_home_category('기타')"><div class="category-title" >기타</div><img src="/resources/images/category-convenience-store.png"></a></div>
	</div>
</div>
...
<%@ include file="common/footer.jsp" %>
		...
		document.getElementById('locationinfosave').value = sessionStorage.getItem('locationInfo');
</html>